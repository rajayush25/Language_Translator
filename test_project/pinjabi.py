...
def translate():
    ...
    # Translate the extracted text from Punjabi to the selected language
    if selected_lang == 'Marathi':
        translated_text = translate_text(extracted_text, 'pa', 'mr')
    elif selected_lang == 'Gujarati':
        translated_text = translate_text(extracted_text, 'pa', 'gu')
    elif selected_lang == 'Hindi':
        translated_text = translate_text(extracted_text, 'pa', 'hi')
    elif selected_lang == 'Bengali':
        translated_text = translate_text(extracted_text, 'pa', 'bn')
    elif selected_lang == 'English':  # Assuming English is the default language of OCR output
        translated_text = translate_text(extracted_text, 'pa', 'en')
...
language_dropdown = tk.OptionMenu(root, language_var, "Marathi", "Gujarati", "Hindi", "Bengali", "English")

...
def translate():
    ...
    if selected_lang in lang_codes:
        ...
        # Translate to Punjabi if the detected language is English or Punjabi
        if detected_lang in ['en', 'pa']:
            translated_text = translate_text(extracted_text, lang_codes[detected_lang], lang_codes[selected_lang])
        else:
            translated_text = "Can't detect English or Punjabi."

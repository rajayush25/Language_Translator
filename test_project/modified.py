...
def translate():
    ...
    # Language code mapping for additional Indian regional languages
    lang_codes = {
        "Marathi": "mr",
        "Gujarati": "gu",
        "Hindi": "hi",
    ...
    if selected_lang in lang_codes:
        translated_text = translate_text(extracted_text, 'en', lang_codes[selected_lang])
...
language_dropdown = tk.OptionMenu(root, language_var, "Marathi", "Gujarati", "Hindi", "Bengali", "Tamil", "Telugu", "Kannada", "Malayalam", "Punjabi", "Odia", "Assamese")

...
def translate():
    ...
    if selected_lang == 'English':
        ...
        translated_text = translate_text(extracted_text, 'pa')
    else:
        translated_text = translate_text(extracted_text, selected_lang)
...
# List of supported languages including English, Punjabi, and other regional languages
required_languages = ['English', 'Punjabi', 'Marathi', 'Gujarati', 'Bengali', 'Hindi', 'Tamil', 
                      'Telugu', 'Kannada', 'Malayalam', 'Odia', 'Urdu', 'Sanskrit']

language_dropdown = tk.OptionMenu(root, language_var, *required_languages)
language_dropdown.pack()
